...
func newStation(db *gorm.DB, opts ...gen.DOOption) station {
	...
	_station.District = field.NewString(tableName, "district")
...
func (s *station) WithContext(ctx context.Context) IStationDo { return s.stationDo.WithContext(ctx) }

func (s station) TableName() string { return s.stationDo.TableName() }

func (s station) Alias() string { return s.stationDo.Alias() }

func (s station) Columns(cols ...field.Expr) gen.Columns { return s.stationDo.Columns(cols...) }
...
func (s *station) fillFieldMap() {
	...
	s.fieldMap["contact_number"] = s.ContactNumber
	s.fieldMap["manager_name"] = s.ManagerName
	s.fieldMap["opening_hours"] = s.OpeningHours
	s.fieldMap["status"] = s.Status
	s.fieldMap["description"] = s.Description
	s.fieldMap["login_pwd"] = s.LoginPwd
}
